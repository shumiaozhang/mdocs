import{_ as s,c as i,o as n,a4 as a}from"./chunks/framework.E4YCCYO0.js";const g=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"ts/关于ts的知识点.md","filePath":"ts/关于ts的知识点.md"}'),l={name:"ts/关于ts的知识点.md"},p=a(`<div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"></span>
