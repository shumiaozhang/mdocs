import{_ as s,o as n,c as a,U as l}from"./chunks/framework.adbdbaa5.js";const A=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"ts/Enum类型/3. 同名Enum的合并.md","filePath":"ts/Enum类型/3. 同名Enum的合并.md","lastUpdated":1711942069000}'),p={name:"ts/Enum类型/3. 同名Enum的合并.md"},o=l(`<p>就是多个同名的Enum结构会自动合并</p><div class="language-typescript"><button title="Copy Code" class="copy"></button><span class="lang">typescript</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#C792EA;">enum</span><span style="color:#A6ACCD;"> </span><span style="color:#FFCB6B;">Foo</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">{</span></span>
