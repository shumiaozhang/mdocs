import{_ as s,o as n,c as a,U as p}from"./chunks/framework.adbdbaa5.js";const d=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"ts/Enum类型/6. Enum类型-反向映射.md","filePath":"ts/Enum类型/6. Enum类型-反向映射.md","lastUpdated":1711942069000}'),l={name:"ts/Enum类型/6. Enum类型-反向映射.md"},e=p(`<p>对于数值Enum可以通过成员值获得成员名。</p><div class="language-typescript"><button title="Copy Code" class="copy"></button><span class="lang">typescript</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#C792EA;">enum</span><span style="color:#A6ACCD;"> </span><span style="color:#FFCB6B;">Weekdays</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">{</span></span>
...
<span class="line"><span style="color:#A6ACCD;">console</span><span style="color:#89DDFF;">.</span><span style="color:#82AAFF;">log</span><span style="color:#A6ACCD;">(Weekdays[</span><span style="color:#F78C6C;">3</span><span style="color:#A6ACCD;">]) </span><span style="color:#676E95;font-style:italic;">// Wednesday</span></span></code></pre></div>`,2),o=[e];function t(c,r,y,_,i,C){return n(),a("div",null,o)}const A=s(l,[["render",t]]);export{d as __pageData,A as default};
